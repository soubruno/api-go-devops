...
func main() {
	...
	// Se as variaveis de banco estiverem presentes, conecta ao Postgres
	if dbHost != "" && dbUser != "" && dbPassword != "" && dbName != "" {
		...
		// Fallback em memoria para staging no Render ou execucao isolada
		log.Println("Variaveis de banco nao detectadas. Inicializando repositorio em memoria.")
